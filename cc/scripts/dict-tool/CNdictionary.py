  ...
  <script>
    ...
    const JOKES={
      lookup:[
        ...
        "先別關掉，奇蹟正在載入。","正在切詞，刀工需要一點時間。","詞庫很大，我先問一下路。",
        "搜尋結果正在從索引裡爬出來。","API 已出發，還在等紅綠燈。","這個詞有點害羞，不肯出現在結果裡。",
        "正在翻遍字典的每一個角落。","系統有在跑，只是跑姿不太明顯。","關鍵字已收到，答案還在趕路。",
        "資料庫正在回想它把資料放哪了。","斷詞器今天也在為標點符號煩惱。","搜尋範圍太大，正在縮小人生。",
        "結果快到了，先不要重新整理。","快取說它好像看過這個詞。","正在從千萬個字裡認出你要的那個。",
        "索引翻得太快，不小心翻過頭了。","你的關鍵字正在接受身分驗證。","系統正在確認這不是錯別字。",
        "文字已進站，結果尚未到站。","查詢佇列前方還有幾個迷路的人。","伺服器正在用盡全力保持淡定。",
        "字典內容很多，翻頁需要一點肌肉。","斷詞器正在決定哪裡該分手。","搜尋不是迷路，只是在探索替代路線。",
        ...
        "這不是延遲，是答案的鋪陳。","正在確認這個詞有沒有雙重身分。","資料庫正在努力回憶，很久以前的事。",
        "你的查詢已插隊失敗，乖乖排隊中。","文字分析中，標點符號請先退場。","詞性還沒站好，結果不能拍照。",
        ...
        "分詞模型正在舉手表決。","同一個字有很多意思，正在逐一問話。","系統忙著消化你剛才那一長串。",
        "搜尋結果很豐富，正在挑能看的。","伺服器沒有失聯，只是回訊息比較慢。","正在清理查詢裡的雜訊和小情緒。",
        "詞庫開門了，但答案還在搭電梯。","正在對答案進行最後一次靈魂拷問。","查詢引擎說：這題我好像會。",
        "字詞配對中，請給它們一點私人空間。","正在確認你找的是詞，不是回憶。","結果已經很近了，近到看不見。",
        "系統正在將耐心轉換成搜尋結果。","斷詞器卡在一段複雜的關係裡。","字典正在開會，討論該派誰回答。",
        "搜尋進度正常，正常地有一點慢。","你的關鍵字已成功引起系統注意。","正在從文字堆裡挖掘知識化石。",
        "答案沒有消失，只是暫時不在服務區。","資料庫翻了個身，繼續努力。","正在建立索引，也建立彼此的信任。",
      ...
      rewrite:[
        ...
        "稍候，資料正在排隊進場。","不是你網路慢，是字典太有深度。","正在努力理解你想表達什麼。",
        "有些詞一轉身，就是一輩子的載入。","查詢結果正在醞釀，可能有點濃。","系統忙著找詞，沒空解釋。",
        "快了快了，這次可能是真的。","你的詞正在跟伺服器玩躲貓貓。","正在整理文字，順便整理心情。",
        "資料不是不來，只是不想面對。","找不到答案時，先怪網路。","每一次載入，都是對耐心的測驗。",
        "請保持冷靜，字典比你更慌。","正在幫這個詞換一套說法。","原句很好，只是想換個髮型。",
        ...
        "正在替平凡的句子加一點戲。","這句話已送進語言美容院。","近義詞很多，合得來的沒幾個。",
        "正在確認替代詞沒有偷偷改變立場。","句子需要新鮮感，但不需要新劇情。","語意不能跑，文字可以換。",
        "正在把重複用字請出會議室。","這個詞太常加班，換別人上場。","替代方案正在接受語感測試。",
        "正在調整措辭，不調整你的本意。","句子正在重新穿搭，風格稍候。","想法不變，只幫它換一種表情。",
        "正在尋找比「很好」更好的「很好」。","每個近義詞都很近，但距離不太一樣。","文字正在搬家，語意負責監工。",
        "正在把生硬的詞按摩得自然一點。","這句話有點直，正在幫它轉彎。","改寫不是變心，只是換個說法。",
        "正在確認新詞能不能融入這個家庭。","語氣太重，先幫它卸下一點行李。","語氣太輕，正在替它增加存在感。",
        "正在把書面語和口語安排相親。","句子已經不錯，現在追求更不錯。","替換詞正在做最後的語意體檢。",
        "正在避免優雅地表達錯誤意思。","文字看似相同，個性其實差很多。","正在挑一個讀起來不會跌倒的版本。",
        "這個詞太嚴肅，請它先放鬆。","原句正在旁邊看著我們動手術。","正在把拗口的地方磨成圓角。",
        "替代詞已到場，還在互相比較。","這句話想低調，正在收起浮誇用詞。","這句話想有力，正在偷偷練肌肉。",
        "正在為你的意思尋找最佳代言人。","語感很玄，系統正在努力假裝懂。","一字之差，可能差了整齣連續劇。",
        "正在保持原意與文采的微妙和平。","這個詞可以換，但感情不能淡。","改寫引擎正在避免畫蛇添足。",
        ...
        "近義詞不是複製人，也有自己的脾氣。","正在處理「意思對，但感覺怪」的問題。","換一個詞，整句話可能就換了天氣。",
        "正在讓句子自然到像沒改過。","這個意思很清楚，說法還在迷路。","正在將普通用字升級成稍微不普通。",
        "句子已重新排列，請確認情緒沒有遺失。","語意已鎖定，文字正在自由發揮。","最佳替代詞即將從候選名單中勝出。",
        "改寫完成前，請先相信文字的可能性。"
      ],
      handwriting:[
        ...
        "影片在壓縮，字在害羞。","起筆很重要，所以先讓它深呼吸。","收筆也很重要，不能下班得太隨便。",
        "正在從第一筆開始，沒有偷吃步。","橫要平，心可以不用。","豎要直，人生不一定。",
        "撇出去容易，捺回來很難。","這一點雖小，少了整個字都不對。","筆尖已就位，紙張正在做心理準備。",
        "正在確認這一筆該彎還是該放下。","墨還沒乾，請不要急著翻頁。","字正在長大，一筆就是一歲。",
        "正在播放筆畫界的慢動作重播。","寫快叫簽名，寫慢才叫筆順。","每一筆都有方向，除了人生。",
        "正在幫筆畫排好出場順序。","偏旁先站好，部首等等要點名。","這一橫走得很穩，值得掌聲。",
        ...
        "每個轉折都是筆尖的小型考驗。","筆畫沒有塞車，只是依序通行。","正在讓這個字站得穩一點。",
        "寫歪沒關係，動畫會假裝沒看見。","這一撇出去，可能就不回來了。","正在收拾剛剛那個豪邁的捺。",
        "筆尖走過的路，都是標準答案。","先寫中間還是兩邊？規則正在發言。","正在替每一筆標上出場號碼。",
        "字的骨架已完成，細節正在入住。","一筆接一筆，像很有耐心的骨牌。","筆順動畫正在逐格證明自己沒寫錯。",
        ...
        "寫字是門藝術，載入也是。","筆順不能跳號，每一筆都要簽到。","正在讓點、橫、豎各就各位。",
        "字還差一筆，像話只說到一半。","收筆收得漂亮，才算體面地結束。","正在演示筆尖如何優雅地急轉彎。",
        "這一折很關鍵，折錯就成了別的字。","筆畫正在紙上進行接力賽。","動畫沒有變慢，是書法時間比較細緻。",
        "正在對齊重心，免得這個字站不穩。","字形施工中，請戴好安全帽。","第一筆已落下，現在沒有回頭路了。",
        "筆尖正在按照祖傳規則前進。","這個字外表安靜，筆畫其實很忙。","正在完成那一筆畫龍點睛的點。",
        "手腕已轉彎，動畫很快就跟上。","撇捺正在左右展開，請保持距離。","字已完成九成，最後一筆正在耍帥。",
        "正在讓筆畫首尾呼應，彼此有個照應。","紙上路線已規劃，筆尖準備導航。","最後一筆即將落下，請屏住呼吸。",
        "字寫完了嗎？等墨乾了才算。"
      ]
    };
